      ...
      <div class="col-10">
        ...
        <div class="wrapper">
          <div class="card" style="width: 96rem">
                      ...
                      <tbody>
                        <tr>
                          <td colspan="2">
                            <small class="text-muted"
                              >Total Cheques KES {{ totalcheques }}
                            </small>
                            <div
                              width="466"
                              id="ember683"
                        ...
                        <tr>
                          <td
                            ...
                            width="50%"
                            data-ember-action=""
                            data-ember-action-684="684"
                          >
                            <div class="current-balance">
                              <small class="text-open uppercase">Current</small>
                              <div class="legend over-flow" title="KES0.00">
                                KES0.00
                              </div>
                            </div>
                          </td>
                            ...
                            >
                              <div class="overdue-balance">
                                ...
                                <div title="KES0.00">
                                  <div
                                    id="ember686"
                                    class="ember-view legend cursor-pointer over-flow"
                                  >
                                    KES0.00
                                  </div>
                                </div>
                              ...
                              <div
                                id="ember687"
                                class="d-none popover bs-popover-bottom ember-view"
                              >
                                <!---->
                              </div>
                            </div>
                    ...
                    <table class="table table-bordered">
                      <tbody>
                        <tr>
                          <td colspan="2">
                            <small class="text-muted"
                              >Total Receipts KES {{ totalcheques }}
                            </small>
                            <div
                              width="466"
                              id="ember683"
                    ...
                    <table class="table table-bordered">
                      <tbody>
                        ...
                        <tr>
                          ...
                          >
                            <div class="current-balance">
                              <small class="text-open uppercase">Actual</small>
                              <div class="legend over-flow" title="KES0.00">
                                KES0.00
                              </div>
                            </div>
            ...
            <tabs :mode="mode">
              <tab title="Receive Payments"
                ><p>Payments Receipts</p>
                {{ this.orgprofileid }} // {{ this.companyid }}
                ...
                <table class="table-bordeless table-hover table-striped walla">
                  <thead>
                    <tr>
                      <th scope="col">#</th>
                      ...
                      <td>
                        ...
                        <div v-if="item.customertype == 2">
                          <!-- <button
																		...
																		class="btn btn-success"
																		data-toggle="modal"
																		data-target="#AllocateReceiptsEmployer"
																	>
																		Distribute
																	</button> -->
                        </div>
              ...
              <tab title="Make Payments">
                <!-- <p> make your cheques </p> -->
                <h3></h3>
                <div class="topnav-right">
                  <button
                    type="button"
              ...
              <tab title="Bank Transactions"
                ...
                <table class="table-bordeless table-hover table-striped walla">
                  ...
                  <tbody>
                    <tr v-for="loan in bankTrasactionStore" :key="loan.id">
                      <td>{{ loan.id }}</td>
                      <td>{{ loan.Transaction_date }}</td>
                      <td>{{ loan.ReferenceNo }}</td>
                      <td>{{ loan.ChequeNo }}</td>
                      <td>{{ loan.notes }}</td>
                      <td>{{ loan.bank }}</td>
                      <td>{{ loan.paid_to_email }}</td>
                      <td>{{ loan.Amount }}</td>
              ...
              <tab title="Banks">
                ...
                <div
                  class="chart-hide-show primarychart-container mt-5 pr-0"
                  style="max-height: 235px"
                >
                  <div
                    id="ember912"
                    class="ember-view px-5 pt-4 row no-gutters"
                  >
                    <div class="d-flex flex-wrap pr-3 col-lg-9">
                      <div class="text-left d-flex mb-3 pr-6 pb-4 graph-ele">
                        ...
                        <div class="pl-3 over-flow">
                          <div class="over-flow font-xs pb-1">Cash In Hand</div>
                          <div
                            id="ember913"
                      ...
                      <div class="text-left d-flex mb-3 pr-6 pb-4 graph-ele">
                        ...
                        <div class="pl-3 over-flow">
                          <div class="over-flow font-xs pb-1">Bank Balance</div>
                          <div
                            id="ember914"
                            class="tooltip-container ember-view over-flow font-medium text-medium direction-ltr"
                          >
