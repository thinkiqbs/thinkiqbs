...
<template>
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-10">
        <div class="row">
          <div class="col-sm-is-12-desktop">
            <div class="card">
              <div class="card-header">
                <div class="card-header"><h3>Sacco Operations</h3></div>
                ...
                <div class="card">
                  <div class="card-body">
                    <tabs :mode="mode">
                        ...
                        <table class="table table-hover walla">
                          ...
                          <tbody>
                            <tr v-for="member in tableData" :key="member.id">
                              ...
                              <td>{{ member.email }}</td>
                              <td>
                                <div v-if="member.Application_Status == false">
                                  <strong style="color: green"
                                    ><button
                                      @click="approve(member)"
                                      class="button-secondary-color-dark"
                                    >
                                      Approve
                                    </button></strong
                                  >
                          ...
                          <table class="table table-hover walla">
                            <thead>
                              <tr>
                                ...
                                <th cope="col">Date</th>
                                <th cope="col">Email</th>
                                <th cope="col">Loan Type</th>
                                <th cope="col">Amount</th>
                                <th cope="col">Loan Term</th>
                                <!-- <th cope="col">Status</th> -->
                      ...
                      >
                      <tab class="link-secondary" title="Deposits Schedule"
                        ><h3></h3>
                      ...
                      <tab title="Loan Schedules"
                        ...
                        <table class="table walla">
                          <thead>
                            <tr>
                              <th cope="col">ID</th>
                              <th cope="col">date_disbursed</th>
                              <th cope="col">Email</th>
                              <!-- <th cope="col">Loan Type</th> -->
                              <!-- <th cope="col">Amount</th> -->
                              <th cope="col">amount_disbursed</th>
                              <th cope="col">amountpaid</th>
                              <th cope="col">Action</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr v-for="loan in loanschedule" :key="loan.id">
                              <td>{{ loan.id }}</td>
...
export default {
  ...
  mounted() {
    ...
    axios
      ...
      .then((res) => {
        this.savings = res.data.results.filter((savings) =>
          savings.Document.includes("deposits")
        );
        $("#walla").DataTable();
        console.log(res.data.results);
      })
