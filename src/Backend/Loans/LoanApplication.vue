          ...
          <div class="col-sm-is-12-desktop">
            <div class="card">
              <div class="card-header">
                <div class="card-header"><h4>Loan Applications</h4></div>

                <div class="alert alert-warning" role="alert">
                  <p>
                    <strong>Warning!</strong>
                    <br />
                    This is where you approve or reject a loan application .
                    <br />
                        ...
                        <div class="topnav-right">
                          <ul class="select">
                            <select
                              ...
                              style="float: right"
                            >
                              <option default value="" disabeled>
                                Select Menu
                              </option>
                              <option value="members">members</option>
                              <option value="loans">Loans</option>
                              <option value="loanapplications">
                                Loans Applications
                              </option>
                          ...
                          <table class="table table-hover walla">
                            <thead>
                              <tr>
                                ...
                                <th cope="col">GL account</th>
                                <th cope="col">Company ID</th>
