            ...
            <div class="col-sm-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">All Repayments</h4>
                  <div
                  ...
                  <table class="table table-hover walla">
                    ...
                    <tbody>
                      <tr v-for="product in tableData" :key="product.id">
                        ...
                        <td>
                          {{ product.memberemail }} {{ product.last_name }}
                        </td>
    ...
    getProducts() {
      axios
        .get("/finance/api/v1/documents/", {
          params: { organizationprofile: this.user_id, Transaction_type: "DR" },
        })
        .then((res) => {
