          ...
          <div class="col-sm-is-12-desktop">
            <div class="card">
              <div class="card-header">
                <div class="card-header"><h3>Loan Schedule</h3></div>

                <div class="card">
                  <div class="card-body">
                    <table class="table table-bordered .walla">
                      <thead>
                        <tr>
                          <th scope="col">ID</th>
                          ...
                          <th scope="col">Paid to Member</th>
                          <th scope="col">Received from Member</th>
  ...
  mounted() {
    ...
    axios
      .get("/finance/api/v1/documents/", {
        params: { organizationprofile: this.user_id, Document: "loans" },
      })
      .then((res) => {
