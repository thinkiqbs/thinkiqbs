					...
					<div class="modal-body">
						<form onsubmit="return false;" class="modal-content">
							<div class="container">
								...
								<p>
									A member will contribute the amount you indicate below.
								</p>
								...
								<input
									...
									id="DepositsAmount"
									placeholder=""
									v-model="this.contribution.Amount"
									hidden
								/>
								...
								<p>
									You are about to add a new Deposit Type {{ this.message }}
      ...
      setTimeout(() => {
		...
		computed: {
			...
			uidsavingtypekey() {
				return (
					this.companyid3 +
					this.contribution.accountcode +
					this.membersavings.id
				);
			},
			...
			interestmonthly() {
				let int = Math.round(
					(this.tLoans - this.Loans.Amount) / this.Loans.Term
				);
