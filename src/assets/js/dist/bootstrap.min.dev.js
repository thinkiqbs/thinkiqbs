...
!(function (t, e) {
  ...
  const d = function d (t) {
    const e = u(t)
    return e && document.querySelector(e) ? e : null
  }
  const f = function f (t) {
    const e = u(t)
    return e ? document.querySelector(e) : null
  }
  const h = function h (t) {
    if (!t) return 0
  ...
  const g = function g (t) {
    return (t[0] || t).nodeType
  }
  const m = function m (t, e) {
    let n = !1
    const i = e + 5
  ...
  const A = function A (t, e, n) {
    k.set(t, e, n)
  }
  const L = function L (t, e) {
    return k.get(t, e)
  }
  const C = function C (t, e) {
    k.delete(t, e)
  }
  const D = /[^.]*(?=\..*)\.|.*/
  const S = /\..*/
  ...
  const et = (function (t) {
    ...
    return (
      ...
      (n._addTouchEventListeners = function () {
        const t = this
        const e = function e (_e) {
          t._pointerEvent && tt[_e.pointerType.toUpperCase()]
            ? (t.touchStartX = _e.clientX)
            : t._pointerEvent || (t.touchStartX = _e.touches[0].clientX)
        }
  ...
  const st = (function (t) {
    function e (e, n) {
      ...
      for (
        ...
        l !== null && c.length && ((i._selector = l), i._triggerArray.push(a))
      }
  ...
  const mt = (function (e) {
    ...
    return (
      ...
      (i.dropdownInterface = function (t, e) {
        ...
        if (
          (n || (n = new i(t, _typeof(e) == 'object' ? e : null)),
          typeof e === 'string')
        ) {
          if (void 0 === n[e]) {
      ...
      (i.clearMenus = function (t) {
        if (!t || (t.button !== 2 && (t.type !== 'keyup' || t.key === 'Tab'))) {
          for (
            let e = V.find('[data-bs-toggle="dropdown"]'), n = 0, o = e.length;
            n < o;
            n++
          ) {
  ...
  const It = (function (e) {
    ...
    return (
      ...
      (a._fixTitle = function () {
        ...
        const e = _typeof(this._element.getAttribute('data-bs-original-title'));
    ...
    return (
      ...
      (e.jQueryInterface = function (t) {
        return this.each(function () {
          ...
          const i = _typeof(t) == 'object' ? t : null
  ...
  const Ut = (function (t) {
    ...
    return (
      ...
      (n._getConfig = function (t) {
        if (
          typeof (t = s({}, Kt, _typeof(t) == 'object' && t ? t : {}))
            .target !== 'string' &&
          g(t.target)
        ) {
          let e = t.target.id
      ...
      (e.jQueryInterface = function (t) {
        return this.each(function () {
          ...
          if (
            (n || (n = new e(this, _typeof(t) == 'object' && t)),
            typeof t === 'string')
          ) {
            if (void 0 === n[t]) {
              throw new TypeError('No method named "' + t + '"')
