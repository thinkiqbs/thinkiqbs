 ...
 */ (function (e, t) {
  ...
  function u (e) {
    ...
    const d = s.width || e.clientWidth || p.right - p.left
    const a = s.height || e.clientHeight || p.bottom - p.top
  ...
  function G (e) {
    ...
    const n = ce.slice(o + 1).concat(ce.slice(0, o))
  ...
  const me = te && /Firefox/i.test(navigator.userAgent)
  const he = [
    'auto-start',
    'auto',
    'auto-end',
  ...
  return (
    (ue.Utils = (typeof window === 'undefined' ? global : window).PopperUtils),
    (ue.placements = he),
    (ue.Defaults = {
      placement: 'bottom',
      positionFixed: !1,
      ...
      modifiers: {
        ...
        hide: {
          ...
          fn: function (e) {
            ...
            const o = C(e.instance.modifiers, function (e) {
        ...
        computeStyle: {
          ...
          fn: function (e, t) {
            ...
            const r = C(e.instance.modifiers, function (e) {
            ...
            const h = q(e, window.devicePixelRatio < 2 || !me)
