      ...
      <div id="appCapsule">
          ...
          <div class="wallet-card">
            ...
            <div class="balance">
              <div class="left">
                ...
                <h1 class="total">{{ this.currentdeposits }}</h1>
              </div>
              <div class="right">
                <a
                  href="#"
            ...
            <div class="wallet-footer">
              ...
              <div class="item">
                <a href="#" data-bs-toggle="modal" data-bs-target="#Payments">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <div class="appHeader">
                  ...
                  <div class="pageTitle">My Pledges</div>
                  <div class="right">
              ...
              <div class="modal-body">
                ...
                <div id="appCapsule">
                  <div class="section mt-2 mb-2">
                    <div class="goals">
                      <li v-for="item in mymonthdeposits" :key="item.id">
                        <!-- item -->
                        <div class="item">
                          <div class="in">
                            <div>
                              <h4>{{ item.SavingsType }}</h4>
                              <p>Gaming</p>
                            </div>
        ...
        >
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title"><h2>New Pledge</h2></h5>
                <a href="javascript:;" data-bs-dismiss="modal">Close</a>
              </div>
              <div class="modal-body">
                <form onsubmit="return false;" class="modal-content">
                  <div class="container">
                    <p>
                      Please fill in this form to create an new member Deposit
                      type.
                    </p>
                    ...
                    <label for="inputAddress" hidden>Account Code </label>
                    <input
                      type="number"
                      class="form-control"
                      id="DepositsAmount"
        ...
        >
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="PaymentsDialogue">Make Payment</h5>
              ...
              <div class="modal-body">
                <form @submit.prevent="makepayments">
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      <label hidden for="inputEmail4">Email</label>
                      <input
                        type="email"
                        class="form-control"
                        id="emailpayment"
                    ...
                    <div class="form-group col-md-6">
                      <label hidden for="userid">user_id</label>
                      <input
                        type="number"
                        class="form-control"
                        id="userid"
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      />
                      <hr
                        class="bg-danger border-2 border-top border-success"
                      />
                      ...
                      <span>Selected: {{ selectedPaymentmode }}</span>
                      ...
                      <label for="paymentRef">#Ref</label>
                      <input
                        type="text"
                        class="form-control"
                        id="paymentRef"
                      ...
                      <input
                        ...
                        class="form-control"
                        id="notes"
                        placeholder="Tell us something bout this payment "
                      ...
                      <div class="card" style="width: 18rem">
                        <div class="card-body">
                          ...
                          <input
                            ...
                            class="form-control"
                            id="Loanpayment"
                            v-model="this.monthlyloan"
                          />
                          <a href="#" class="link-primary">Pay Loan</a>
                          ...
                          <input
                            ...
                            class="form-control"
                            id="DepositsPayment"
                            v-model="this.mymonthlydeposits"
                          />
                          <a href="#" class="link-primary">Pay Deposits</a>
                          ...
                          <input
                            ...
                            class="form-control"
                            id="DepositsPayment"
                            v-model="this.PaymentAmount"
                          />
                          <a href="#" class="link-primary" @click="makepayments"
                            >Pay Total Amount
                          </a>
                        </div>
                      </div>
        ...
        <!-- Loan Application -->
        <div class="modal fade modalbox" id="loan" tabindex="-1" role="dialog">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
              ...
              <div class="modal-body">
                <div class="container">
                  ...
                  <div>
                    <table class="table-responsive table-striped walla">
                      <thead>
                        <tr class="line-item-header">
                          ...
                          <th class="text-left"><small>Term</small></th>
                          ...
                          <th class="text-left"><small>Due</small></th>

                          <!----><!---->
                        </tr>
                      </thead>
                      <tbody>
                        <tr v-for="item in myapprovedloans" :key="item.id">
                          <td>
                            <small>{{ item.date_disbursed }}</small>
                          </td>
                          <td>{{ item.id }}</td>
                          <td>
                            <small>{{ item.loan_Type }}</small>
                          </td>
                          <td>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                >
                  <li v-for="item in myloans1" :key="item.id">
                    <div class="card col">
        ...
        >
          <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">My Loans</h5>
                <button
                  type="button"
                  class="close"
                  data-bs-dismiss="modal"
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        ...
                        <input
                          ...
                          class="form-control"
                          id="Deposit_Date"
                          placeholder="Enter Deposits Date "
                          v-model="withdrawal.Deposit_Date"
                        />
                      </div>
                    </div>
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        ...
                        <input
                          ...
                          id="Amount"
                          placeholder=""
                          v-model="withdrawal.Deposit_Amount"
                        />
                      </div>
                      {{ this.withdrawal.Deposit_Date }}
                    </div>
                  </form>
                </div>
              </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  <tr>
                    <td>
                      <img
                        ...
                        style="width: 240px; height: 143.8px"
                        id="logo_content"
                      />
                    </td>
                    ...
                    <td width="50%" class="pcs-orgname text-align-right">
                      ...
                      <span style="white-space: pre-wrap" id="tmp_org_address"
                        >Locatons Details
                      </span>
                    </td>
                  </tr>
                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              style="padding-top: 6px; line-height: 30px"
                            >
                            ...
                            <span
                              ...
                              ><strong
                                ><span
                                  ...
                                  ><a href="#/contacts/1952913000000243001"
                                    >{{ this.first_name }}
                                    {{ this.last_name }}</a
                                  ></span
                                ></strong
                    ...
                    <td style="padding: 20px 0px 30px 0px" valign="bottom">
                      ...
                      >
                        <tbody>
                          ...
                          <tr>
                            <td class="pcs-label" style="padding-top: 4px">
                              Loans Balance
                            </td>
                            <td
                              style="padding: 6px 0px 0px 6px"
                ...
                >
                  <thead>
                    <tr height="26">
                      <th width="5%" class="pcs-itemtable-header"><b>#</b></th>
                      ...
                      <th
                        width="13%"
                        class="text-align-left pcs-itemtable-header"
                      >
                        <b>Amount</b>
                      </th>
                      <th
                  ...
                  <tbody class="itemBody">
                    <tr v-for="(item, index) in myloanstatement" :key="item.id">
                      <th width="5%" scope="row">{{ index + 1 }}</th>
                      <td width="15%">{{ item.Transaction_date }}</td>
                      <td width="14%">{{ item.Document }}</td>
                      <td width="25%">{{ item.notes }}</td>
                      <td
                        width="13%"
                        class="text-align-right pcs-itemtable-details"
                      >
                        {{ item.Amount }}
                      </td>
                      <td
        ...
        >
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">Guarantors</h5>
                <a href="javascript:;" data-bs-dismiss="modal">Close</a>
              </div>
              ...
              <div class="modal-body">
                <ul class="listview image-listview">
                  <ul id="example-1">
                    <li v-for="item in allMyguarantors" :key="item.id">
                      <a href="#" class="item">
                        <img
                          ...
                          <div>
                            ...
                            <div class="table-responsive">
                              ...
                              >
                                ...
                                <tbody>
                                  <tr
                                    v-for="(item, index) in allMyguarantors"
                                    :key="item.id"
                                  >
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <ul class="listview image-listview">
                  <ul id="example-1">
                    <li v-for="item in allMyguarantee" :key="item.message">
                      <a href="#" class="item">
                        <img
                          src="src/assets/images/faces/4.jpg"
                          alt="image"
                          ...
                          <div>
                            ...
                            <div class="transactions table-responsive">
                              ...
                              >
                                ...
                                <tbody>
                                  <tr
                                    v-for="(item, index) in allMyguarantee"
                                    :key="item.id"
                                  >
                                    <th scope="row">{{ index + 1 }}</th>
          ...
          <div class="row mt-2">
            ...
            <div class="col-6">
              <div class="stat-box">
                ...
                <div class="value text-danger">{{ this.maxtopup }}</div>
              </div>
            </div>
          </div>
          <div class="row mt-2">
            ...
            <div class="col-6">
              <div class="stat-box">
                <div class="title">Guarnteed to others</div>
                <div class="value">0</div>
              </div>
            </div>
          </div>
        ...
        <div class="section mt-4">
          ...
          <div class="transactions">
            ...
            >
              ...
              <div class="right">
                <div class="price text-danger">{{ this.totalLoans }}</div>
              </div>
            </a>
            <!-- * item -->
            <!-- item -->
            <a href="app-transaction-detail.html" class="item">
              ...
              <div class="right">
                <div class="price text-danger">- {{ this.myloanspaid }}</div>
              </div>
            </a>
            <!-- * item -->
            <!-- item -->
            <a href="app-transaction-detail.html" class="item">
              ...
              <div class="right">
                <div class="price">+ {{ this.currentdeposits }}</div>
              </div>
            </a>
            <!-- * item -->
            <!-- item -->
        ...
        <div class="section full mt-4">
          <div class="section-heading padding">
            <h2 class="title">My Loans</h2>
            <a
              href="#"
              class="link"
              data-bs-toggle="modal"
              data-bs-target="#loanlist"
              >View All</a
            >
          </div>
          <div
                ...
                <li v-for="item in myloans1" :key="item.id">
                  <div class="carousel-item active">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <h2 class="card-title">{{ item.loan_Type }}</h2>
                        <div class="wide-block p-0">
                          <div class="card">
                            <ul
                              class="listview flush transparent image-listview"
                            >
                              <li>
                                <a href="#" class="item">
                                  <div class="icon-box">
        ...
        <div class="section full mt-4 mb-3">
          <div class="section-heading padding">
            <h2 class="title">Saving Products</h2>
                ...
                <li v-for="item in savings" :key="item.id">
                  <div class="carousel-item active">
                    <div class="card">
                      <!-- <img src="..." class="card-img-top" alt="..."> -->
                      <div class="card-body">
                        <h2 class="card-title">{{ item.saving_type }}</h2>
                        <p class="card-text">
                          {{ item.saving_description }}
                        </p>

                        <p class="card-text">
                          Minimum Contribution : {{ item.minimum_contribution }}
                        </p>
        ...
        <div class="section full mt-4 mb-3">
          <div class="section-heading padding">
            <h2 class="title">Loan Products</h2>
            <a href="app-blog.html" class="link">View All</a>
          </div>
          <div
            id="carouselExampleControls"
          ...
          >
            <div class="carousel-inner">
              <ul id="example-1">
                <li v-for="item in loantypes" :key="item.id">
                  <div class="carousel-item active">
                    <div class="card">
                      <!-- <img src="..." class="card-img-top" alt="..."> -->
                      <div class="card-body">
                        <h2 class="card-title">{{ item.loan_type }}</h2>
                        <p class="card-text">
                          {{ item.loan_description }}
                        </p>

                        <ul>
                          <li>
                            Maximum Guarantors : {{ item.no_of_guarantors }}
                          </li>

                          <li>Interest Rate : {{ item.interest_rate }}</li>

                          <li>
                            Interest Calculation : {{ item.interest_calc_mode }}
                          </li>
                        </ul>
        ...
        <div class="appFooter">
          <div class="footer-title">
            #ThinkiqDigital 2022. All Rights Reserved.
          </div>
        </div>
        <!-- * app footer -->
      </div>
          ...
          <div class="modal-content">
            <div class="modal-body p-0">
              ...
              <div class="profileBox pt-2 pb-2">
                ...
                <div class="in">
                  <strong
                    ...
                    {{ this.memberlastname }}</strong
                  >
                  <div class="text-muted">{{ this.memberaccounname }}</div>
                </div>
                <a
                  href="#"
              ...
              <div class="sidebar-balance">
                ...
                <div class="in">
                  <h1 class="amount">{{ this.currentdeposits }}</h1>
                </div>
              </div>
              <!-- * balance -->
              ...
              <ul class="listview flush transparent no-line image-listview">
                ...
                <li>
                  <a href="app-pages.html" class="item">
                    ...
                    <div class="in">Guarantor Status</div>
                  </a>
                </li>
                <li>
...
export default {
  ...
  data() {
    return {
      ...
      columns: ["Userid", "email", "description", "created_date"],
  ...
  axios.post("https:codepadding.com", body, {
    ...
    countadmin: function () {
      axios
        ...
        .then((res) => {
          this.admincheck = res.data.count;
        });
    ...
    //make bootstrap select picker function for search
    makeSelectPicker: function () {
      $(".selectpicker").selectpicker();
    },

    // store value in a data property

    loantypechange() {
      const opt = this.loantypes.find((o) => o.loan_type === this.selected);

      this.maxloanterm = this.$store.getters.allLoantype.filter(
        (item) =>
          item.company_id == this.companyid && item.loan_type == this.selected
      )[0].maximum_loan_term;

      this.interestrate = this.$store.getters.allLoantype.filter(
        (item) =>
          item.company_id == this.companyid && item.loan_type == this.selected
      )[0].interest_rate;
    ...
    format_date(depositdate) {
      if (depositdate) {
        return moment(String(depositdate)).format("YYYYMMDD");
      }
    },
    withdrawals() {
      axios
        .post(`http://127.0.0.1:8000/Savings/api/v1/Deposits/`, {
          ...
          Deposit_date: this.withdrawal.Deposit_Date,
          Deposit_Amount: this.withdrawalamount,
          RefNumber: "",
          type: "withdrwal",
          Approved: false,
          company_id: this.companyid,
    ...
    saveloan() {
      axios
        ...
        .then((response) => {
          response;
          this.fetchLoans();
          // (this.message = "New loan created for"), response.email;
        })
        .catch((e) => {
          this.errors.push(e);
          alert(e);
    ...
    makepayments() {
      axios
        .post(`/finance/api/v1/PaymentsReceived/`, {
          ...
          loan: this.monthlyloan,
          interest: 0,
          deposits: this.mymonthlydeposits,
          Amount: 0,
          company_id: this.usercompanyid,
        })
        .then((response) => {
  ...
  computed: {
    ...
    // usercompanyid() {
    // 	var y = this.userinfo[0].company_id;
    // 	return y;
    // },
    ...
    PaymentAmount() {
      return Number(
        ...
        this.monthlyloan + this.mymonthlydeposits
      );
    },
    depositdate() {
    ...
    uidsavingtypekey() {
      return this.user_id + this.contribution.accountcode;
    },
    currentdeposits: function () {
      var sum = 0;
      this.mydepositsnow.forEach((e) => {
        sum += e.Amount;
      });
      return sum.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
    },

    currentdepositsx: function () {
      var sum = 0;
      this.mydepositsnow.forEach((e) => {
        sum += e.Amount;
      });
    ...
    exposure: function () {
      // this.currentdeposits -this.totalloans
      var num1, num2, num3;
      num1 = this.currentdeposits;
      num2 = Number(this.loanbalance);
      num3 = this.Loans.Amount;

      return num3 - num1 - num2;
    },

    maxtopup: function () {
      return this.currentdepositsx * 3 - this.loanbalance;
    },

    totalLoans: function () {
      var sum = 0;
      this.myloansdocs.forEach((e) => {
        sum += e.Amount;
      });
      return sum;
    },

    myloanspaid: function () {
      var sum = 0;
      this.myloansdocspaid.forEach((e) => {
        sum += e.Credit;
      });
      return sum * 1;
    },
    ...
    loanbalance: function () {
      // var sum = 0;
      // this.loansdocument.forEach((e) => {
      // 	sum += e.Amount;
      // });
      // return sum;
      return this.totalLoans; //- this.myloanspaid;
    },
    ...
    monthlyloan: function () {
      var sum = 0;
      this.myloans1.forEach((e) => {
        sum += e.Monthrepayment;
      });
      return sum;
    },

    mydepositsnow: function () {
      return this.$store.getters.allDocuments.filter(
        (item) => item.memberemail == this.email && item.Document == "deposits"
      );
    },
    ...
    myloanstatement() {
      return this.$store.getters.allDocuments.filter(
        (item) => item.memberemail == this.email && item.Document == "loans"
      );
    },
    ...
    myloansdocspaid() {
      return this.$store.getters.allDocuments.filter(
        (item) =>
          item.memberemail == this.email && item.Transaction_type == "DR"
      );
    },

    myapprovedloans() {
      return this.$store.getters.allLoans.filter(
        (item) => item.email == this.email && item.Status == 4
      );
    },

    totalapprovedloans() {
      var sum = 0;
      this.myapprovedloans.forEach((e) => {
        sum += e.Amount;
      });
      return sum.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
    },
    ...
    savings() {
      return this.$store.getters.allSavinttype.filter(
        (item) => item.company_id == this.companyid2
      );
    },
